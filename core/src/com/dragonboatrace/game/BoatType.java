...
public enum BoatType {
    ...
    FAST("fastBoat",     4,     3,              1,          1,      1,          1,          new Vector2(100, 100),  "Boats/fast.jpg"),
    NORMAL("normalBoat", 3,     2,              2,          2,      2,          2,          new Vector2(100, 100),  "Boats/normal.jpg"),
    HEAVY("heavyBoat",   3,     1,              4,          3,      2,          1,          new Vector2(100, 100),  "Boats/heavy.jpg"),
    LIGHT("lightBoat",   3,     3,              1,          1,      1,          3,          new Vector2(100, 100),  "Boats/light.jpg"),
    AGILE("agileBoat",   3,     2,              2,          2,      2,          3,          new Vector2(100, 100),  "Boats/agile.jpg"),
    STRONG("strongBoat", 3,     2,              3,          3,      3,          1,          new Vector2(100, 100),  "Boats/strong.jpg");
